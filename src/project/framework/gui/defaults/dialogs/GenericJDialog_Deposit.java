...
public class GenericJDialog_Deposit extends javax.swing.JDialog
{
	...
	public GenericJDialog_Deposit(IDisplayFrameGUI iDisplayFrameGUI, String title, String aaccnr)
	{
		...
		//{{ INIT_CONTROLS 
		setTitle(title != null ? title : "Deposit");
		setModal(true);
	...
	{
        parentframe.setDepositAmount(JTextField_Deposit.getText());
        dispose();
	}
