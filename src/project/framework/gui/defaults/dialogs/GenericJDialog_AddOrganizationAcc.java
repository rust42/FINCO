...
public class GenericJDialog_AddOrganizationAcc extends javax.swing.JDialog {
    ...
    public GenericJDialog_AddOrganizationAcc(IDisplayFrameGUI iDisplayFrameGUI, String dialogTitle) {
        super(iDisplayFrameGUI.getCurrJFrame());
        parentframe = iDisplayFrameGUI;
    ...
    public DefaultUIAccFormInput getAccFormInput() {
        DefaultUIAccFormInput uiAccFormInput = new DefaultUIAccFormInput();
        uiAccFormInput.setAccountnr(JTextField_ACNR.getText());
        uiAccFormInput.setClientName(JTextField_NAME.getText());
        uiAccFormInput.setStreet(JTextField_STR.getText());
    ...
    public void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
        DefaultUIAccFormInput accFormInput = this.getAccFormInput();
    ...
    public JTextField getJTextField_NoOfEmp() {
        return JTextField_NoOfEmp;
    }
}